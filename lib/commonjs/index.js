...
exports.resetSession =
  exports.isFoundationModelsEnabled =
  exports.generateWithTools =
  exports.generateText =
  exports.generateStructuredOutput =
  exports.configureSession =
  exports.AppleLLMSession =
    void 0;
var _NativeAppleLLMModule = _interopRequireDefault(
  require("./NativeAppleLLMModule")
);
...
const AppleLLMModule = _NativeAppleLLMModule.default;
if (!AppleLLMModule) {
